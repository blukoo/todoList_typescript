<template>
  <div
    class="popWrap"
    :style="{ height: popInnerHeight + 'px' }"
    @click="blurCalendar"
  >
    <div class="popInner">
      <div class="calendarWrap" v-if="popset.calendar.flag">
        <div>
          <v-calendar
            ...
            @dayclick="onDayClick"
            :is-expanded="true"
            ><DatePicker v-model="date" :attruibutes="attr"></DatePicker
          ></v-calendar>
        </div>
      </div>
      ...
      <div class="btnWrap">
        <button v-if="popset.cancelBtn.flag" @click="closePop">
          {{ popset.cancelBtn.text }}
        </button>
        <button
          class="active"
          @click="confirmPop"
          v-if="popset.confirmBtn.flag"
        >
          {{ popset.confirmBtn.text }}
        </button>
      </div>
    </div>
  </div>
